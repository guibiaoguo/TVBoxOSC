...
//            mHandler.postDelayed(mHideChannelInfoRun, 6000);
    ...
    public void getEpg() {
        ...
        UrlHttpUtil.get("https://epg.112114.xyz/?ch=" + URLEncoder.encode(channelName.replace("+", "[add]").toString()) + "&date=" + timeFormat.format(date), new CallBackUtil.CallBackString() {
